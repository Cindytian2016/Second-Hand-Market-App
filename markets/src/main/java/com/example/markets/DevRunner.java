...
public class DevRunner implements ApplicationRunner {
    ...
    private void loadItemData() {
        ...
        itemRepository.saveAll(List.of(
                ...
                new ItemEntity(null,"Smartphone1", "Latest model smartphone", 800.00),
                new ItemEntity(null,"Smartphone2", "Latest model smartphone", 900.00),
                new ItemEntity(null,"Smartphone3", "Latest model smartphone", 100.00),
                new ItemEntity(null,"Smartphone4", "Latest model smartphone", 1800.00),
                new ItemEntity(null,"Smartphone5", "Latest model smartphone", 2800.00),
